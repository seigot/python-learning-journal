...
class RouteGraph:
    ...
    def get_path(self, previous, destination):
        path = []
        current = destination
...
for a, b, cost in edges:
    route_graph.add_edge(a, b, cost)

for library, junction, cost in library_edges:
    route_graph.add_edge(library, junction, cost)

distances, previous = route_graph.dijkstra("Current Location")

for library in libraries:
    path = route_graph.get_path(previous, library)
    print(library)
